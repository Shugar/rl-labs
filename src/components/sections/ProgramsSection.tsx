...
const plans = [
  ...
  },
  {
    ...
    features: [
      "2 Live Group Coaching Sessions/week",
      "Guest Sessions with Professional Players & Coaches",
      "Library of Past Lessons and Training Resources",
  ...
  },
  {
    ...
    features: [
      ...
      "2 Private Coaching Sessions/week",
      "Unlimited Asynchronous Replay Reviews",
      "A Personalized Weekly Improvement Routine",
      "Direct, Private Access to Kinseh for Questions",
    ],
    elite: true,
  },
];
